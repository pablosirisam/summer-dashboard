...
const CFG: Record<ObjType, {
  ...
  ia:    { label: 'Inteligencia Artificial', tag: 'Horas de trabajo real',  icon: Brain,    accent: '#d9a441', accent2: '#f0c26a', glow: '217,164,65',  unit: 'h' },
  food:  { label: 'Alimentación',            tag: 'Calidad de la dieta',    icon: Salad,    accent: '#7fa96b', accent2: '#9dc587', glow: '127,169,107',  unit: '★', yMax: 5 },
  sport: { label: 'Deporte',                 tag: 'Minutos en movimiento',  icon: Dumbbell, accent: '#d2624a', accent2: '#e68463', glow: '210,98,74',  unit: 'min' },
}
